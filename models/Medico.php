...
class Medico extends Persona{
    ...
    public function getData($connection, Medico $filters){
        ...
        $sql_filters = $this -> setParameters($filters)["filters"];
        $parameters = $this -> setParameters($filters)["parameters"];
    ...
    public function setNewData($connection, Medico $data){
        ...
        $sql_columns = $this -> setParameters($data)["columns"];
        $sql_values = $this -> setParameters($data)["values"];
        $parameters = $this -> setParameters($data)["parameters"];
        ...
        if($data = $statement -> fetch(PDO::FETCH_ASSOC)){
            ...
            $arrayAssoc["response"] = "Registro realizado con éxito";
        }
